      ...
      <div class="l-wrapper">
        ...
        <div class="row">
          <div class="col-pad-12">
            ...
            <section class="faq">
            	<ul class="categories">
            		<li><a class="selected" href="#portes-et-fenetres"><?= _( 'Portes et Fenêtres' ); ?></a></li>
            	...
            	<div class="faq-items">
            		<ul id="portes-et-fenetres" class="faq-group">




            			<li class="faq-title"><h2><?= _( 'Portes et Fenêtres' ); ?></h2></li>
            			<li>
            				<a class="trigger" href="#0">Comment prendre les mesures d'une fenêtre?</a>
                      ...
                      <div class="row">
                        ...
                        <div class="col-pad-08">
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae quidem blanditiis delectus corporis, possimus officia sint sequi ex tenetur id impedit est pariatur iure animi non a ratione reiciendis nihil sed consequatur atque repellendus fugit perspiciatis rerum et. Dolorum consequuntur fugit deleniti, soluta fuga nobis. Ducimus blanditiis velit sit iste delectus obcaecati debitis omnis, assumenda accusamus cumque perferendis eos aut quidem! Aut, totam rerum, cupiditate quae aperiam voluptas rem inventore quas, ex maxime culpa nam soluta labore at amet nihil laborum?</p>
                        </div>
                      </div>
            				</div> <!-- faq-content -->
            			</li>
            			...
            			<li>
            				<a class="trigger" href="#0">Comment prendre les mesures d'une porte?</a>
            				<div class="faq-content">
