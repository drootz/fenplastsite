  ...
  <div id="battant" class="l-section m-product-first">
    <div class="l-wrapper">

        <h2><?= _( 'Fenêtres à battants' ); ?></h2>


        <h3><?= _( 'Gamme Eco©' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-eco"></div>
          </div>
          <div class="col-09">
            <p><?= _( 'Présentement, les fenêtres de la série Eco© n\'existent que dans les modèles à battant, à auvent et fixe.' ); ?></p>
            <p><?= _( 'Les différents cadres de la fenêtre EcoPlus© ont tous une épaisseur de 5 ¾” et sont disponibles en 3 configurations d’extensions d’aluminium selon vos besoins : plats et avec un épaulement soit de ½ pouce ou de 1 pouce.' ); ?></p>
            <p><?= _( 'Le cadre 5 3/4" permet un positionnement du volet plus rapproché de la partie chaude du mur (réduisant ainsi la condensation) en parfaite harmonie avec la norme Novoclimat.' ); ?></p>
            <p><img src="img/product/eco_txt_01.jpg" width="100%" height="auto" <?= "alt=\"" . _( 'mesures' ) . "\""; ?></p>
          </div>
        </div>



        <h3><?= _( 'Gamme EcoPlus©' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-ecoPlus"></div>
          </div>

          <div class="col-09">
            <p><?= _( 'Fenplast fait incursion dans le domaine des fenêtres hybrides avec un modèle de type battant nommé EcoPlus©. ' ); ?></p>
            <p><?= _( 'Avec ses profilés droits et épurés cette fenêtre reflète la tendance actuelle en matière d’habitation.' ); ?></p>
          ...
          <div class="row">
            <div class="col-03">
              <div class="m-img img-iso"></div>
            </div>
            <div class="col-09">
              <p><?= _( 'Tel qu’illustré, la série Iso© est disponible en épaisseur de 4 1/2", 5 3/4" plat (fenêtres à battant, auvent et panoramiques seulement) ou de 5 3/4" avec moulure extérieure (ME). ' ); ?></p>
              <p><?= _( 'L’extérieur du cadre 5 3/4" ME en surplomb permet d’y accoter une brique, d’y insérer un revêtement dans la cavité prévue à cette fin ou encore de le commander réduit d’un demi-pouce pour une rénovation spécifique. ' ); ?></p>
              <p><?= _( 'La partie intérieure du cadre de la série Iso© est prévue pour recevoir un soufflage ou un gypse pour combler l’espace entre le cadre de la fenêtre et le mur intérieur.' ); ?></p>
              <ul>
                <li><?= _( 'Dans une nouvelle construction, elle permet un positionnement du volet plus rapproché  de la partie chaude du mur (réduisant ainsi la condensation).' ); ?></li>
                <li><?= _( 'Lors d’une rénovation impliquant un remplacement de boîte, vous profiterez des avantages énoncés plus haut en plus d’une variété de moulures et de soufflages qui permettent de personnaliser le cadre pour une installation adaptée aux exigences particulières de votre maison.' ); ?></li>
              </ul>
              <p><img src="img/product/iso_txt_01.jpg" width="100%" height="auto" <?= "alt=\"" . _( 'mesures' ) . "\""; ?></p>
            </div>
          </div>
          ...
          <h3><?= _( 'Gamme IsoPlus©' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-isoPlus"></div>
            </div>
            <div class="col-09">
          ...
          <h3><?= _( 'Gamme IsoPlus© à auvent' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-isoPlusAuvent"></div>
            </div>
            <div class="col-09">
  ...
  <div class="m-hero hero-02">
    <div id="coulissante" class="l-section m-product-second white-overlay">
      <div class="l-wrapper">
          ...
          <h2><?= _( 'Fenêtres coulissantes IsoVision©' ); ?></h2>



          <h3><?= _( 'Fenêtre DOUBLE' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-isoVisionDouble"></div>
            </div>
            <div class="col-09">
          ...
          <h3><?= _( 'Fenêtre SIMPLE' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-isoVisionSimple"></div>
            </div>
            <div class="col-09">
  ...
  <div id="saillie" class="l-section m-product-third">
    <div class="l-wrapper">

        <h2><?= _( 'Fenêtres en saillie' ); ?></h2>



        <h3><p><?= _( 'Gamme Iso©' ); ?></p></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-isoSaillie"></div>
          </div>
          <div class="col-09">
            <p><?= _( 'Quoi de mieux qu’une fenêtre en baie (3 sections) ou en arc (4 ou 5 sections) pour mettre en valeur votre résidence ? Ces fenêtres sont offertes avec diverses possibilités de finition intérieure, soit en chêne, en pin ou en stratifié, rehaussant ainsi de façon spectaculaire l’esthétisme de ce type d’ouverture. ' ); ?></p>
            <p><?= _( 'Ces fenêtres peuvent également être fabriquées avec des angles propres à vos exigences, procurant ainsi une finition impeccable, particulièrement pour vos besoins en rénovation. Ces fenêtres en saillie vous procureront une luminosité remarquable et fourniront un endroit idéal pour la croissance de vos fleurs et plantes.' ); ?></p>
            <p><?= _( 'À l\'extérieur, ces fenêtres peuvent aussi être enjolivées par des panneaux <a target="_BLANK" href="http://www.fenplast.com/fr/evo-i.aspx">Evoi©</a>.' ); ?></p>
          </div>
        </div>
...
<div class="m-hero hero-02">
  <div id="fixe" class="l-section m-product-fourth white-overlay">
    <div class="l-wrapper">
        ...
        <h2><?= _( 'Fenêtres fixes' ); ?></h2>


        <h3><?= _( 'Gamme EcoPano©' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-ecoPano"></div>
          </div>
          <div class="col-09">
        ...
        <h3><?= _( 'Gamme IsoPano©' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-isoPano"></div>
          </div>
          <div class="col-09">
    ...
    <div id="irreguliere" class="l-section m-product-fifth">
      <div class="l-wrapper">

          <h2><?= _( 'Fenêtres en forme irrégulières' ); ?></h2>



          <h3><?= _( 'Gamme EcoGeo©' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-ecoGeo"></div>
            </div>
            <div class="col-09">
          ...
          <h3><?= _( 'Gamme IsoGeo©' ); ?></h3>
          <div class="row">
            <div class="col-03">
              <div class="m-img img-isoGeo"></div>
            </div>
            <div class="col-09">
...
<div class="m-hero hero-02">
  <div id="guillotine" class="l-section m-product-sixth white-overlay">
    <div class="l-wrapper">
        ...
        <h2><?= _( 'Fenêtres en guillotines IsoVent©' ); ?></h2>



        <h3><?= _( 'Guillotine DOUBLE' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-isoVentDouble"></div>
          </div>
          <div class="col-09">
        ...
        <h3><?= _( 'Guillotine SIMPLE' ); ?></h3>
        <div class="row">
          <div class="col-03">
            <div class="m-img img-isoVentSimple"></div>
          </div>
          <div class="col-09">
...
<!--
  <div class="m-hero hero-02">
    <div id="produit-fenetres" class="l-section m-produit-fenetres white-overlay">
      <div class="l-wrapper">
        ...
        <div class="row">
          <div class="col-pad-06">
            <div class="m-product-wrapper clearfix">
              <h2 class="m-product-name">Nom du Produit</h2>
              <div class="m-product-thumbnail">
                <img src="http://placehold.it/300x300/ee343f/002543.jpg?text=Fenêtre">
              </div>
              <p class="m-product-description">Description du Produit - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <p class="m-product-info"><a target="_BLANK" href="#"><?= _( 'En savoir plus...' ); ?></a></p>
            </div>
          </div>
